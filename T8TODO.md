...
- Work out how and when to do functional tests for submodules (esp.
  r8format/pylib/cmtconv/Test).
- Move much README docs to t8dev/README
- Go through gb8dev commits and pull information/changes from there into
  t8dev
